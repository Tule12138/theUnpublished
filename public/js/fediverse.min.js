const fed=getElement("fediverse-comments");if(fed)var commentsLoaded,bskyCommentsLoaded,replies=0,reblogs=0,favourites=0;const mstdRoot=getElement("mastodon-comments"),tootUri=mstdRoot.dataset.uri,respondToVisibility=(e,t)=>{const n=new IntersectionObserver(e=>{e.forEach(e=>{e.intersectionRatio>0&&t()})},{root:null});n.observe(e)},cmt=getElement("comments"),i18nReplies=cmt.dataset.i18nReplies,i18nReblogs=cmt.dataset.i18nReblogs,i18nFavourites=cmt.dataset.i18nFavourites,i18nLoading=cmt.dataset.i18nLoading,i18nErr=cmt.dataset.i18nErr,i18nNoComment=cmt.dataset.i18nNoComment,cmtSty=document.createElement("style");if(cmtSty.textContent=`
    ...
    @media print {
        ...
        <a class="replies ${n(t,"replies")}" href="${t.url}" rel="nofollow" aria-label="${i18nReplies}">
    ...
    `,i=e=>{let t=`@${e.acct}`;if(!e.acct.includes("@")){const n=new URL(e.url);t+=`@${n.hostname}`}return t},a=(e,t)=>{const n=e.filter(e=>e.in_reply_to_id===t).sort((e,t)=>e.created_at.localeCompare(t.created_at));n.forEach(t=>c(e,t))},t=tootUri.split("/"),c=(e,n)=>{const c=escapeHtml(n.account.display_name);n.account.display_name=c,n.account.emojis.forEach(e=>{n.account.display_name=n.account.display_name.replace(`:${e.shortcode}:`,`<img src="${escapeHtml(e.static_url)}" alt="Emoji ${e.shortcode}" height="20" width="20" />`)});const r=`
